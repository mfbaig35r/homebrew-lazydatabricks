class Lazydatabricks < Formula
  ...
  homepage "https://github.com/mfbaig35r/lazybricks"
  ...
  # Homebrew blocks network during build, so we need all deps as resources
  # Use: pip download lazydatabricks -d /tmp/pkgs --no-binary :all:
  # Then generate resources from downloaded files
  ...
  resource "databricks-sdk" do
    url "https://files.pythonhosted.org/packages/5d/df/7d2588b0559748cbe6da44b8edb7ffcbeded5bc6c048650000410fda09fe/databricks_sdk-0.86.0.tar.gz"
    sha256 "decc7d24f9231d666419dff98a339f04697a237d9022e182b5426969ae8ac8d2"
  end
